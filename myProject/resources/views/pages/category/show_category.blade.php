            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$name->category_name}}</li>
                        @endforeach
                    </ul>
                </div>
            </div>
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                @foreach($category as $key => $cate)
                                    <a href="{{URL::to('danh-muc-san-pham/'.$cate->category_id)}}" class="list-group-item list-group-item-action"> {{$cate->category_name}}  <small class="text-muted">(150) </small></a>
                        ...
                        <div class="filter-brand-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                @foreach($brand as $key => $brand)
                                    <a href="{{URL::to('thuong-hieu-san-pham/'.$brand->brand_id)}}" class="list-group-item list-group-item-action"> {{$brand->brand_name}}  <small class="text-muted">(150) </small></a>
                                @endforeach
                            </div>
                        </div>
    ...
    <div class="shop-box-inner" >
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-4">{!!$category_by_id->links()!!}</div>
