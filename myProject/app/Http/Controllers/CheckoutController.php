...
class CheckoutController extends Controller
{
   ...
   /* public function calculate_fee(Request $request){
    ...
    public function payment(Request $request){
        ...
        $url_canonical = $request->url();
        //--seo
        return view('pages.checkout.payment')->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
    ...
    public function order_place(Request $request){
        ...
        /*$edit_shipping=DB::table('tbl_shipping')->where('shipping_id',$brand_product_id)->get();*/
        $shipper['shipper_id']=$request->shipping_option;
        DB::table('tbl_shipping')->where('shipping_id',Session::get('shipping_id'))->update($shipper);
        ...
        if($data['payment_method']==2){
            ...
            return view('pages.checkout.handcash')->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
    ...
    public function manage_order(){
        ...
        $manager_order  = view('admin.manage_order')->with('order',$all_order);
